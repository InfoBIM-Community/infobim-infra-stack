...
- Capability: Found `org.infobim.base.capability.list_sewage_pipes`.
- Args: Requires `file`. User provided `project.ifc`.
**Response**:
"I will analyze the sewage pipes and their slopes."
```bash
!./infobim run org.infobim.base.capability.list_sewage_pipes --file project.ifc
```
...
- **Sewage Analysis** (`org.infobim.base.capability.list_sewage_pipes`): Checks slope compliance...
